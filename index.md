        ...
        var a = e("../common/PlayerInfo")
          ...
          , m = function(e) {
            ...
            t.prototype.update = function(e) {
                ...
                this.node.y + this.node.width / 2 > cc.find("Canvas/lineNode").children[0].y && 0 == this.pengzhuangCount && this.endCtrl && 0 == this.endOne && this.testEndDJS > 3 && true) {//æ— æ•Œ(æŠŠå‰é¢çš„trueæ”¹ä¸ºfalseå³å¯æ— æ•Œ)
                    a.default.GameUpdateCtrl = !1,
                    a.default.playerTouch = !1;
            ...
            t.prototype.onBeginContact = function(e, t, n) {
                ...
                "fruit" == n.node.group) {
                    ...
                    var c = this.fruitNumber
					  ...
					  //åˆæˆé€»è¾‘0-8(0ä¸ºè‘¡è„ï¼Œ8ä¸ºæ¤°å­)
                    ...
                    cc.tween(t.node).to(.1, {
                        ...
                        var c = new cc.Node;
                        c.addComponent(cc.Sprite).spriteFrame = l.default.Instance.fruit[10],//ç»“æŸç•Œé¢æ°´æžœ
                        ...
                        var s = new cc.Node;
                        s.addComponent(cc.Sprite).spriteFrame = l.default.Instance.fruit[10],//ç»“æŸç•Œé¢æ°´æžœ
                        s.parent = c,
                        s.position = cc.v2(0),
